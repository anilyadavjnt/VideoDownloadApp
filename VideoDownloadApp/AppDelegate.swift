...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, handleEventsForBackgroundURLSession identifier: String, completionHandler: @escaping () -> Void) {
        ...
        // Verify this is our background session
        guard identifier == Constants.backgroundDownloadIdentifier else {
            completionHandler()
            return
        }
        ...
        print("App was launched/resumed for background URL session: \(identifier)")
    }
